...
export function TurkishStreetFoodSection({ locale }: { locale: string }) {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Reveal delay={0.1} duration={0.6}>
          <div className="my-12 relative rounded-2xl overflow-hidden aspect-[16/7]">
            <Image
              src="/images/turkish-wraps-blog.webp"
              alt="Turkish street food wraps prepared at Midyaji Basha"
              fill
