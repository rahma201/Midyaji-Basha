...
export function LocaleFooter({ locale }: { locale: string }) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12 locale-text-start">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed mb-6" style={{ color: '#9ca3af', ...arabicFont }}>{dict.footer.tagline}</p>
        ...
        >
          <div>
            <h3 className="text-xl font-bold mb-2" style={{ color: '#F8F6F1', fontFamily: isRTL ? 'var(--font-arabic), sans-serif' : 'var(--font-playfair), serif' }}>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center sm:justify-between gap-2" style={{ borderTop: '1px solid rgba(255,255,255,0.07)' }}>
          <p className="text-xs" style={{ color: '#6b7280', ...arabicFont }}>{dict.footer.rights}</p>
          <p className="text-xs" style={{ color: '#6b7280', ...arabicFont }}>{dict.footer.madeWith}</p>
        </div>
      </div>
    </footer>
  )
